...
namespace CrawlerDotnet.Processor
{
    public class ReflectionHelper
    {
        ...
        public static Dictionary<string, Tuple<ESelectorType, string>> GetPropertyAttributes<TEntity>()
        {
            var attributeDictionary = new Dictionary<string, Tuple<ESelectorType, string>>();
